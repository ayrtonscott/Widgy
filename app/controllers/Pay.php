...
class Pay extends Controller {
    ...
    public function index() {
        ...
        if(settings()->payment->taxes_and_billing_is_enabled && !in_array($this->plan_id, ['free', 'trial', 'custom']) && (empty($this->user->billing->name) || empty($this->user->billing->address) || empty($this->user->billing->city) || empty($this->user->billing->county) || empty($this->user->billing->zip))) {
