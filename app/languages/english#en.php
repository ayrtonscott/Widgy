...
return [
    ...
    'index.custom.nav_item1' => 'HOME',
	'index.custom.nav_item2' => 'ABOUT US',
	'index.custom.nav_item3' => 'WIDGETS',
	'index.custom.nav_item4' => 'PRICING',
	'index.custom.feature1_title' => '¿Social proof?',
	'index.custom.feature1_desc' => 'Social proof, also known as informational social influence, is a psychological phenomenon where <font color = "orange"> people assume that other people\'s actions reflect correct behavior </font> in a specific situation. <br><br>Has this phenomenon ever happened to you? It could be with a restaurant, an online store or just the supermarket.<br><br> Knowing that a person bought and got good results or a 5-star rating were surely <font color="orange">decisive factors to when making a purchase</font>.',
	'index.custom.feature2_title' => 'Your site, your strategy',
	'index.custom.feature2_desc' => 'By installing Widgy on your site, you will be able to configure the notifications so that you can choose <font color="orange">where, when, and how</font> to show them. <br><br>We have specialists in marketing strategies oriented to social proof, who will help you throughout the process..<br><br>What are you waiting for? Join the <font color="orange">+9.000</font> brands that use Widgy to grow their business.',
	'index.custom.register_link' => 'register',

	'custom_notification.title_help' => 'Help',
	...
	'custom.helpcenter' => 'Help Center',
	'custom.dashboard_cust_notifications_not_shown' => '🔥🚀 <strong>Wow! Your site is on fire!</strong><br>You have exceeded the impression limit for this month, you can wait or <a href="plan/upgrade">upgrade</a> your plan.<br><small>Important: Renewing the same plan will not reset the counter. </small>',
	...
	'global.menu.website' => 'Visit website',
	...
	'global.emails.auto_delete_inactive_users.body' => 'Hey there {{NAME}},<br /><br />This is a simple email to let you know that your account has been deleted because of being inactive for more than {{INACTIVITY_DAYS}} days.<br /><br />If you wish to re-gain access, you would need to <a href="{{REGISTER_LINK}}">register</a> another account with us.<br /><br />Greetings from {{WEBSITE_TITLE}}!',
    ...
    'global.plan_settings.notifications_impressions_limit' => '%s Notifications Impressions / month',
	...
	'account.plan.notifications_impressions_limit' => 'You have used %1$s impressions out of %2$s this month. This amount will be reset on the 1st day of each month..',
	...
	'account_payments.filters.processor_offline_payment' => 'Offline payment',
	...
	'register.error_message.name_length' => 'Name must be between 3 and 64 characters!',
	...
	'dashboard.campaigns.header' => 'Campaigns',
	'dashboard.campaigns.create' => 'Create Campaign',
	'dashboard.campaigns.name' => 'Campaign',
	'dashboard.campaigns.date' => 'Launched on',
	'dashboard.campaigns.is_enabled' => 'Status',
	'dashboard.campaigns.is_enabled_tooltip' => 'Change the status of the Campaign',
	'dashboard.campaigns.no_data' => 'There are no campaigns at the moment, why not create one?',

	'dashboard.filters.search_by_name' => 'Name',
	'dashboard.filters.search_by_domain' => 'Domain',
	'dashboard.filters.order_by_name' => 'Name',

	'campaign.title' => '%s Campaign',
	'campaign.breadcrumb' => 'Campaign',

	'campaign.header.custom_branding' => 'Custom Branding',
	'campaign.header.pixel_key' => 'Install Pixel',

	'campaign.filters.type' => 'Type',
	'campaign.filters.search_by_name' => 'Name',
	'campaign.filters.order_by_name' => 'Name',

	'campaign.notifications.header' => 'Campaign notifications',
	'campaign.notifications.create' => 'Create notification',
	'campaign.notifications.link' => 'Notifications',
	'campaign.notifications.name' => 'Notification',
	'campaign.notifications.type' => 'Type',
	'campaign.notifications.display_trigger' => 'Trigger',
	'campaign.notifications.display_duration' => 'Duration',
	'campaign.notifications.is_enabled' => 'Status',
	'campaign.notifications.is_enabled_tooltip' => 'Change the status',
	'campaign.notifications.display_duration_unlimited' => 'Forever',
	'campaign.notifications.no_data' => 'There are no notifications for this campaign, why not create one?',
	...
	'campaign.error_message.campaigns_limit' => 'You have exceeded the limit of campaigns on your plan.',
	...
	'create_campaign_modal.input.name' => 'Name',
	'create_campaign_modal.input.domain' => 'Domain / Subdomain',
	'create_campaign_modal.input.domain_placeholder' => 'ex: domain.com or subdomain.domain.com',
	'create_campaign_modal.input.domain_help' => 'The domain name of the website where the campaign is going to run.',
	'create_campaign_modal.input.domain_help2' => 'Notifications will NOT work on other domains other than what you define here.',
	'create_campaign_modal.input.include_subdomains' => 'Include Subdomains',
	'create_campaign_modal.input.include_subdomains_help' => 'All the subdomains will match on this campaign as well if checked.',

	'update_campaign_modal.header' => 'Update Campaign',
	'update_campaign_modal.subheader' => 'Change an already existing campaign.',

	'update_campaign_modal.input.name' => 'Name',
	'update_campaign_modal.input.domain' => 'Domain / Subdomain',
	'update_campaign_modal.input.domain_placeholder' => 'ex: domain.com or subdomain.domain.com',
	'update_campaign_modal.input.domain_help' => 'The domain name of the website where the campaign is going to run.',
	'update_campaign_modal.input.domain_help2' => 'Notifications will NOT work on other domains other than what you define here.',
	'update_campaign_modal.input.include_subdomains' => 'Include Subdomains',
	'update_campaign_modal.input.include_subdomains_help' => 'All the subdomains will match on this campaign as well if checked.',


	'campaign_pixel_key_modal.install.header' => 'Install Pixel',
	'campaign_pixel_key_modal.install.subheader' => 'Copy and paste the following JS Code Snippet before the end of the <code></head></code> of your website.',
	...
	'notification.title' => '%s Notification',
	'notification.duplicate' => 'Duplicate',
	...
	'notification.settings.image_help' => 'Leave empty for no image.<br>Hint: <a href="https://icons8.com" target=_BLANK >icons8.com</a> has a good library of small icons that you can use.<br>Also, you can upload your own images to <a href="https://es.imgbb.com/" target=_BLANK >imgbb.com</a>',
	...
	'notification.error_message.notifications_limit' => 'You have exceeded the limit of notifications on your plan.',
	...
	'notification.latest_conversion.name' => 'Latest Conversion',
	'notification.latest_conversion.description' => 'Establish social proof by displaying your most recent conversions on your site.',
	'notification.latest_conversion.icon' => 'fa fa-fw fa-funnel-dollar',
	'notification.latest_conversion.title_default' => 'Someone from England',
	'notification.latest_conversion.description_default' => 'Signed up for the newsletter.',
	'notification.latest_conversion.image_default' => 'https://img.icons8.com/dusk/2x/small-smile.png',
	'notification.latest_conversion.time_ago_default' => '10 mins ago',
	...
	'notification.random_review.name' => 'Random Review',
	'notification.random_review.description' => 'Display a random review/testimonial from your clients to create social proof.',
	'notification.random_review.icon' => 'fa fa-fw fa-random',
	'notification.random_review.title_default' => 'John Doe',
	'notification.random_review.description_default' => 'Widgy is a 5 star product!',
	'notification.random_review.image_default' => 'https://img.icons8.com/color/2x/person-male.png',
	...
	'notification_duplicate_modal.header' => 'Duplicate notification',
	...
	'index.meta_keywords' => '',
	'index.header' => '<strong>Skyrocket</strong> Conversions<br /> & Increase <strong>Growth</strong>.',
	'index.subheader' => 'We are a cloud-based solution that enables businesses to display notifications about a flash sale, discounts, live vistors\' counter, and more..<br><br>You can try it!<br><small><i class="fas fa-check-circle">Start now, its free.  No credit card needed.</i></small>',
	'index.sign_up' => 'Get started ➡',
	'index.breadcrumb' => 'Home',

	'index.steps.header' => 'More engagement, growth & leads.',
	'index.steps.one' => 'Install pixel',
	'index.steps.one_text' => 'Easily integrate it on any website with just one line of code.',
	'index.steps.two' => 'Create your notification',
	'index.steps.two_text' => 'Create and customize your notification however you like it.',
	'index.steps.three' => 'Grow & Profit',
	'index.steps.three_text' => 'Generate more leads, conversions and growth. It\'s that easy.',

	'index.setup.header' => 'Easy setup & integration on any website.',
	'index.setup.description' => 'Any website can run our notifications.',
	'index.setup.shopify' => 'Shopify',
	'index.setup.wordpress' => 'Wordpress',
	'index.setup.zapier' => 'Zapier',
	'index.setup.squarespace' => 'Squarespace',

	'index.tools.header' => 'How it works?',
	'index.tools.subheader' => 'Widgy is an application that integrates with most known services like WooCommerce, Magento, Prestashop and more. <br>It helps you get conversions, bring trust to your site and build customer loyalty through the psychological phenomenon of social proof. <br><font color = "orange">% s </font> notifications have already been printed on all our clients\' websites. <br> <br> Oops! we are already applying it! ❤️ ',
	...
	'index.pricing.subheader' => 'Choose and get your plan based on your needs',

	'index.cta.header' => 'Free 30-day trial',
