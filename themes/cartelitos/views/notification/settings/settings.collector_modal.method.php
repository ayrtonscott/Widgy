...
<?php ob_start() ?>
    ...
    <div id="agreement">
        ...
        <div class="form-group">
            ...
            <input id="settings_agreement_url" name="agreement_url" class="form-control" value="<?= $data->notification->settings->agreement_url ?>" maxlength="2048" /><?php // Modificación 02/01/22 en 10.0.0 - Borramos el type URL ?>
        </div>
    </div>

    <div class="form-group">
        <label for="settings_thank_you_url"><?= language()->notification->settings->thank_you_url ?></label>
        <input id="settings_thank_you_url" name="thank_you_url" class="form-control" value="<?= $data->notification->settings->thank_you_url ?>" /><?php // Modificación 02/01/22 en 10.0.0 - Borramos el type URL ?>
