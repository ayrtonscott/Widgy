...
<div class="d-flex justify-content-between mb-4">
    <div class="d-flex align-items-center">
        <h1 class="h3 mb-0 mr-1"><i class="fa fa-fw fa-xs fa-box-open text-primary-900 mr-2"></i> <?= sprintf(l('admin_plan_update.header'), $data->plan->name) ?></h1>
        ...
        <form action="" method="post" role="form">
            ...
            <div>
                <div class="form-group">
                    ...
                    <small class="form-text text-muted"><?= l('admin_plans.plan.campaigns_limit_help') ?></small>
                </div>
                ...
                <div class="form-group">
                    ...
                    <small class="form-text text-muted"><?= l('admin_plans.plan.notifications_limit_help') ?></small>
                </div>
                ...
                <div class="form-group">
                    <label for="track_notifications_retention"><?= l('admin_plans.plan.track_notifications_retention') ?> <small class="form-text text-muted"><?= l('admin_plans.plan.per_month') ?></small></label>
