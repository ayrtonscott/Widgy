...
<div class="d-flex flex-column flex-lg-row justify-content-between mb-4">
    <div>
        <div class="d-flex justify-content-between">
            <h1 class="h3"><i class="fa fa-fw fa-xs fa-code text-primary-900 mr-2"></i> <?= sprintf(l('admin_api_documentation.header')) ?></h1>
        </div>
    ...
    <div class="col-12 col-lg-4">
        <div class="form-group">
            <label for="api_key"><?= l('admin_api_documentation.api_key') ?></label>
            <input type="text" id="api_key" value="<?= $this->user->api_key ?>" class="form-control form-control-lg" readonly="readonly" />
        </div>

        <div class="form-group">
            <label for="base_url"><?= l('admin_api_documentation.base_url') ?></label>
...
<div class="">
    ...
    <div class="mb-4">
        <h2 class="h4"><?= l('admin_api_documentation.authentication.header') ?></h2>
        <p class="text-muted"><?= l('admin_api_documentation.authentication.subheader') ?></p>
    </div>

    <div class="form-group">
        <label><?= l('admin_api_documentation.example') ?></label>
            ...
            <div class="card-header bg-gray-200 p-3 position-relative">
                <h3 class="h6 m-0">
                    <a href="#" class="stretched-link" data-toggle="collapse" data-target="#users_read_all" aria-expanded="true" aria-controls="users_read_all">
                        <?= l('admin_api_documentation.users.read_all_header') ?>
                    </a>
                </h3>
            </div>
            ...
            <div id="users_read_all" class="collapse">
                <div class="card-body">
                    ...
                    <div class="form-group mb-4">
                        <label><?= l('admin_api_documentation.endpoint') ?></label>
                        <div class="card bg-gray-200 border-0">
                            <div class="card-body">
                    ...
                    <div class="table-responsive table-custom-container mb-4">
                        <table class="table table-custom">
                            <thead>
                            <tr>
                                <th><?= l('admin_api_documentation.parameters') ?></th>
                                <th><?= l('admin_api_documentation.details') ?></th>
                                <th><?= l('admin_api_documentation.description') ?></th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr>
                                <td>page</td>
                                <td><span class="badge badge-info"><?= l('admin_api_documentation.optional') ?></span></td>
                                <td><?= l('admin_api_documentation.filters.page') ?></td>
                            </tr>
                            <tr>
                                <td>results_per_page</td>
                                <td><span class="badge badge-info"><?= l('admin_api_documentation.optional') ?></span></td>
                                <td><?= sprintf(l('admin_api_documentation.filters.results_per_page'), '<code>' . implode('</code> , <code>', [10, 25, 50, 100, 250, 500]) . '</code>', 25) ?></td>
                            </tr>
                            <tr>
                                <td>search</td>
                                <td><span class="badge badge-info"><?= l('admin_api_documentation.optional') ?></span></td>
                                <td><?= l('admin_api_documentation.filters.search') ?></td>
                            </tr>
                            <tr>
                                <td>search_by</td>
                                <td><span class="badge badge-info"><?= l('admin_api_documentation.optional') ?></span></td>
                                <td><?= sprintf(l('admin_api_documentation.filters.search_by'), '<code>' . implode('</code> , <code>', ['name', 'email']) . '</code>') ?></td>
                            </tr>
                            <tr>
                                <td>order_by</td>
                                <td><span class="badge badge-info"><?= l('admin_api_documentation.optional') ?></span></td>
                                <td><?= sprintf(l('admin_api_documentation.filters.order_by'), '<code>' . implode('</code> , <code>', ['email', 'datetime', 'last_activity', 'name', 'total_logins']) . '</code>') ?></td>
                            </tr>
                            <tr>
                                <td>order_by_type</td>
                                <td><span class="badge badge-info"><?= l('admin_api_documentation.optional') ?></span></td>
                                <td><?= l('admin_api_documentation.filters.order_by_type') ?></td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div class="form-group">
                        <label><?= l('admin_api_documentation.response') ?></label>
                        <div class="card bg-gray-200 border-0">
                                        <pre class="card-body">
{
    "data": [
            ...
            <div class="card-header bg-gray-200 p-3 position-relative">
                <h3 class="h6 m-0">
                    <a href="#" class="stretched-link" data-toggle="collapse" data-target="#users_read" aria-expanded="true" aria-controls="users_read">
                        <?= l('admin_api_documentation.users.read_header') ?>
                    </a>
                </h3>
            </div>
            ...
            <div class="card-header bg-gray-200 p-3 position-relative">
                <h3 class="h6 m-0">
                    <a href="#" class="stretched-link" data-toggle="collapse" data-target="#users_create" aria-expanded="true" aria-controls="users_create">
                        <?= l('admin_api_documentation.users.create_header') ?>
                    </a>
                </h3>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive table-custom-container mb-4">
                        <table class="table table-custom">
                            ...
                            <tr>
                                <td>name</td>
                                <td><span class="badge badge-danger"><?= l('admin_api_documentation.required') ?></span></td>
                                <td>-</td>
                            </tr>
                            <tr>
                                <td>email</td>
            ...
            <div class="card-header bg-gray-200 p-3 position-relative">
                <h3 class="h6 m-0">
                    <a href="#" class="stretched-link" data-toggle="collapse" data-target="#users_update" aria-expanded="true" aria-controls="users_update">
                        <?= l('admin_api_documentation.users.update.header') ?>
                    </a>
                </h3>
            </div>
            ...
            <div class="card-header bg-gray-200 p-3 position-relative">
                <h3 class="h6 m-0">
                    <a href="#" class="stretched-link" data-toggle="collapse" data-target="#users_delete" aria-expanded="true" aria-controls="users_delete">
                        <?= l('admin_api_documentation.users.delete_header') ?>
                    </a>
                </h3>
            </div>
            ...
            <div class="card-header bg-gray-200 p-3 position-relative">
                <h3 class="h6 m-0">
                    <a href="#" class="stretched-link" data-toggle="collapse" data-target="#plans_read_all" aria-expanded="true" aria-controls="plans_read_all">
                        <?= l('admin_api_documentation.plans.read_all_header') ?>
                    </a>
                </h3>
            </div>
            ...
            <div class="card-header bg-gray-200 p-3 position-relative">
                <h3 class="h6 m-0">
                    <a href="#" class="stretched-link" data-toggle="collapse" data-target="#plans_read" aria-expanded="true" aria-controls="plans_read">
                        <?= l('admin_api_documentation.plans.read_header') ?>
                    </a>
                </h3>
            </div>
