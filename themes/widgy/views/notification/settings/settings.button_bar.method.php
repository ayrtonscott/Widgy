...
<div class="form-group">
    ...
    <select class="form-control" name="display_position">
        <option value="top" <?= $data->notification->settings->display_position == 'top' ? 'selected="selected"' : null ?>><?= l('notification.settings.display_position_top') ?></option>
        <option value="bottom" <?= $data->notification->settings->display_position == 'bottom' ? 'selected="selected"' : null ?>><?= l('notification.settings.display_position_bottom') ?></option>
        <option value="top_floating" <?= $data->notification->settings->display_position == 'top_floating' ? 'selected="selected"' : null ?>><?= l('notification.settings.display_position_top_floating') ?></option>
        <option value="bottom_floating" <?= $data->notification->settings->display_position == 'bottom_floating' ? 'selected="selected"' : null ?>><?= l('notification.settings.display_position_bottom_floating') ?></option>
    </select>
