    ...
    <form action="" method="post" role="form">
        ...
        <div class="row mb-5">
            <div class="col-12 col-md-4">
                <h2 class="h3"><?= l('account.settings.header') ?></h2>
                <p class="text-muted"><?= l('account.settings.subheader') ?></p>
            </div>
        ...
        <div class="row mb-5" id="billing" style="<?= !settings()->payment->is_enabled || !settings()->payment->taxes_and_billing_is_enabled ? 'display: none;' : null ?>">
            <div class="col-12 col-xl-4">
                <h2 class="h3"><?= l('account.billing.header') ?></h2>
                <p class="text-muted"><?= l('account.billing.subheader') ?></p>
            </div>
        ...
        <div class="row">
            <div class="col-12 col-md-4">
                <h2 class="h3"><?= l('account.twofa.header') ?></h2>
                <p class="text-muted"><?= l('account.twofa.subheader') ?></p>
            </div>
        ...
        <div class="row">
            <div class="col-12 col-md-4">
                <h2 class="h3"><?= l('account.change_password.header') ?></h2>
                <p class="text-muted"><?= l('account.change_password.subheader') ?></p>
            </div>
