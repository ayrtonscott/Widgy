...
<script>
    ...
    function chequear() {
        ...
        if ($('#annual_price').is(':checked')) {
            ...
            var ins = '1) <strong>Ingresa</strong> en el siguiente enlace: <a class="text-info" target="_blank" href=" ' + link + ' " >Suscribirse (ANUAL)</a><br><br> 2) <strong>Confirma la suscripción</strong> de <strong><span class="text-success">$' + parseInt(ARS) + '</span></strong> (ARS) finales.<br><small> Impuestos incluidos</small><br><br>3) <strong>Saca una captura</strong> del comprobante de pago.<br><br>4) Click en <strong>seleccionar archivo</strong> aquí debajo y sube foto el comprobante.<br><br>5) No te olvides de hacer click en <strong>enviar datos</strong> aquí debajo.<br><br><small>Para más información acerca de los cobros podes ver nuestro <a class="text-info" target="_blank" href="<?= HELPCENTER_URL ?>" >centro de ayuda</a>.</small>';
            $("#instrucciones").html(ins);
        }
    }
