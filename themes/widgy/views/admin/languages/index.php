...
<?php if(count(\Altum\Language::$languages)): ?>
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between mb-4">
        <h1 class="h3"><i class="fa fa-fw fa-xs fa-language text-primary-900 mr-2"></i> <?= l('admin_languages.header') ?></h1>
...
<?php else: ?>
    ...
    <div class="d-flex flex-column flex-md-row align-items-md-center">
        ...
        <div class="d-flex flex-column">
            <h1 class="h3"><?= l('admin_languages.header_no_data') ?></h1>
...
<?php \Altum\Event::add_content(include_view(THEME_PATH . 'views/admin/languages/language_delete_modal.php'), 'modals'); ?>
