...
<?php if(count($data->codes) || count($data->filters->get)): ?>
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between mb-4">
        <h1 class="h3"><i class="fa fa-fw fa-xs fa-tags text-primary-900 mr-2"></i> <?= l('admin_codes.header') ?></h1>
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex justify-content-end">
                            <?= include_view(THEME_PATH . 'views/admin/codes/admin_code_dropdown_button.php', ['id' => $row->code_id]) ?>
                        </div>
                    </td>
                </tr>
            <?php endforeach ?>
...
<?php else: ?>
    ...
    <div class="d-flex flex-column flex-md-row align-items-md-center">
        ...
        <div class="d-flex flex-column">
            <h1 class="h3"><?= l('admin_codes.header_no_data') ?></h1>
