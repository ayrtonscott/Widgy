...
<div class="d-flex justify-content-between mb-4">
    <h1 class="h3"><i class="fa fa-fw fa-xs fa-file-alt text-primary-900 mr-2"></i> <?= l('admin_page_create.header') ?></h1>
</div>
        ...
        <form action="" method="post" role="form">
            ...
            <div class="form-group">
                ...
                <select id="type" name="type" class="form-control form-control-lg">
                    <option value="internal" <?= $data->values['type'] == 'internal' ? 'selected="selected"' : null ?>><?= l('admin_pages.input.type_internal') ?></option>
                    <option value="external" <?= $data->values['type'] == 'external' ? 'selected="selected"' : null ?>><?= l('admin_pages.input.type_external') ?></option>
                </select>
            </div>
            ...
            <div class="form-group" data-type="internal">
                ...
                <div class="input-group">
                    ...
                    <input id="url" type="text" name="url" class="form-control form-control-lg <?= \Altum\Alerts::has_field_errors('url') ? 'is-invalid' : null ?>" value="<?= $data->values['url'] ?>" placeholder="<?= l('admin_pages.input.url_internal_placeholder') ?>" required="required" />
            ...
            <div class="form-group" data-type="external">
                <label for="url"><?= l('admin_pages.input.url') ?></label>
                <input id="url" type="url" name="url" class="form-control form-control-lg <?= \Altum\Alerts::has_field_errors('url') ? 'is-invalid' : null ?>" value="<?= $data->values['url'] ?>" placeholder="<?= l('admin_pages.input.url_external_placeholder') ?>" required="required" />
                <?= \Altum\Alerts::output_field_error('url') ?>
            </div>
            ...
            <div class="form-group" data-type="internal">
                ...
                <select id="editor" name="editor" class="form-control form-control-lg">
                    <option value="wysiwyg" <?= $data->values['editor'] == 'wysiwyg' ? 'selected="selected"' : null ?>><?= l('admin_pages.input.editor_wysiwyg') ?></option>
                    <option value="raw" <?= $data->values['editor'] == 'raw' ? 'selected="selected"' : null ?>><?= l('admin_pages.input.editor_raw') ?></option>
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <select id="pages_category_id" name="pages_category_id" class="form-control form-control-lg">
                    ...
                    <option value="" <?= $data->values['pages_category_id'] == '' ? 'selected="selected"' : null ?>><?= l('admin_pages.input.pages_category_id_null') ?></option>
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <select id="position" name="position" class="form-control form-control-lg">
                    <option value="bottom" <?= $data->values['position'] == 'bottom' ? 'selected="selected"' : null ?>><?= l('admin_pages.input.position_bottom') ?></option>
                    <option value="top" <?= $data->values['position'] == 'top' ? 'selected="selected"' : null ?>><?= l('admin_pages.input.position_top') ?></option>
                    <option value="hidden" <?= $data->values['position'] == 'hidden' ? 'selected="selected"' : null ?>><?= l('admin_pages.input.position_hidden') ?></option>
                </select>
            </div>
