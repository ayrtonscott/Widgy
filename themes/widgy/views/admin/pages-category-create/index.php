...
<div class="d-flex justify-content-between mb-4">
    <h1 class="h3"><i class="fa fa-fw fa-xs fa-book text-primary-900 mr-2"></i> <?= l('admin_pages_category_create.header') ?></h1>
</div>
        ...
        <form action="" method="post" role="form">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input id="url" type="text" name="url" class="form-control form-control-lg <?= \Altum\Alerts::has_field_errors('url') ? 'is-invalid' : null ?>" value="<?= $data->values['url'] ?>" placeholder="<?= l('admin_pages_categories.input.url_placeholder') ?>" required="required" />
