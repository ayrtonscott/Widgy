...
<div class="d-flex mb-4">
    <h1 class="h3"><i class="fa fa-fw fa-xs fa-wrench text-primary-900 mr-2"></i> <?= l('admin_settings.header') ?></h1>
</div>
    ...
    <div class="mb-3 mb-xl-5 mb-xl-0 col-12 col-xl-3">
        <div class="d-xl-none">
            <select name="settings_menu" class="form-control">
                ...
                <option value="<?= url('admin/settings/socialproofo') ?>" class="nav-link" <?= $data->method == 'socialproofo' ? 'selected="selected"' : null ?>><?= l('admin_settings.socialproofo.tab') ?></option>
        ...
        <div class="nav flex-column nav-pills d-none d-xl-flex" role="tablist" aria-orientation="vertical">
            ...
            <a class="nav-link <?= $data->method == 'socialproofo' ? 'active' : null ?>" href="<?= url('admin/settings/socialproofo') ?>"><i class="fa fa-fw fa-sm fa-share-alt mr-1"></i> <?= l('admin_settings.socialproofo.tab') ?></a>
