...
<div class="d-flex flex-column flex-md-row justify-content-between mb-4">
    <h1 class="h3"><i class="fa fa-fw fa-xs fa-wallet text-primary-900 mr-2"></i> <?= l('admin_affiliates_withdrawals.header') ?></h1>
    ...
    <table class="table table-custom">
        ...
        <?php foreach($data->affiliates_withdrawals as $row): ?>
            <tr>
                ...
                <td class="text-nowrap">
                    <?php if($row->is_paid): ?>
                        <span class="badge badge-pill badge-success"><i class="fa fa-fw fa-check"></i> <?= l('admin_affiliates_withdrawals.table.is_paid_paid') ?></span>
                    <?php else: ?>
                        <span class="badge badge-pill badge-warning"><i class="fa fa-fw fa-eye-slash"></i> <?= l('admin_affiliates_withdrawals.table.is_paid_pending') ?></span>
                    <?php endif ?>
                </td>
