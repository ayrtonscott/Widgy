...
<section class="container pt-5">
    ...
    <div class="row mb-3">
        <div class="col-12 col-lg mb-3 mb-lg-0">
            <h2 class="h4"><?= l('account_payments.header') ?></h2>
            <p class="text-muted m-0"><?= l('account_payments.subheader') ?></p>
        </div>
                            ...
                            <form action="" method="get" role="form">
                                <div class="form-group px-4">
                                    ...
                                    <select name="processor" id="processor" class="form-control form-control-sm">
                                        ...
                                        <option value="paypal" <?= isset($data->filters->filters['processor']) && $data->filters->filters['processor'] == 'paypal' ? 'selected="selected"' : null ?>><?= l('account_payments.filters.processor_paypal') ?></option>
                                        <option value="stripe" <?= isset($data->filters->filters['processor']) && $data->filters->filters['processor'] == 'stripe' ? 'selected="selected"' : null ?>><?= l('account_payments.filters.processor_stripe') ?></option>
                                        <option value="offline_payment" <?= isset($data->filters->filters['processor']) && $data->filters->filters['processor'] == 'offline_payment' ? 'selected="selected"' : null ?>><?= l('account_payments.filters.processor_offline_payment') ?></option>
                                        <option value="coinbase" <?= isset($data->filters->filters['processor']) && $data->filters->filters['processor'] == 'coinbase' ? 'selected="selected"' : null ?>><?= l('account_payments.filters.processor_coinbase') ?></option>
                                    </select>
                                </div>
    ...
    <?php else: ?>
        <div class="d-flex flex-column align-items-center justify-content-center">
            <img src="<?= ASSETS_FULL_URL . 'images/no_rows.svg' ?>" class="col-10 col-md-6 col-lg-4 mb-3" alt="<?= l('account_payments.payments.no_data') ?>" />
